...
class DataProcessorUpdated:
    def __init__(self, self_back_window = 24, prediction_window = 8, sl_path = '../../datasset/ercot_sl_2019_2023.csv', dap_path = '../../datasset/hourly_ercot_day_ahead_sl_2019_2023.csv', fuel_path = '../../datasset/ercot_fuel_2019_2023.csv', load_path = '../../datasset/ercot_load_2019_2023.csv'):
        self.sl = None
        self.dap = None
    ...
    def clean_and_resample_data(self, file_path, time_col, freq='5min'):
        """
        Load, clean, and resample time-series data.
        :param file_path: Path to the CSV file.
        :param time_col: Name of the timestamp column.
        :param freq: Resampling frequency (default: '5min').
        ...
        try:
            ...
            # Adjust end_time to the nearest hour if needed
            if end_time.minute != 55:
                end_time = end_time.replace(minute=55, second=0)
    ...
    def shift_dap(self):
        self.df['DAP_SystemLambda'] = self.df['DAP_SystemLambda'].shift(-24 * 12)
    ...
    def split_data(self, shift_dap = True, feature_columns = None, target_col='SCED_system_lambda'):
        ...
        self.x_train_df_reg = df.loc[:'2021-12-31 23:55:00', feature_columns]
        self.x_val_df_reg = df.loc['2022-01-01 00:00:00':'2022-12-25 23:55:00', feature_columns]
        self.x_test_df_reg = df.loc['2022-12-25 00:00:05':, feature_columns]
    ...
    def shift_data(self):
        ...
        n_steps_in = 12 * self.look_back_window
        n_steps_out = 12 * self.prediction_window
